...
pub struct RequestContactImport {
    ...
    pub json_body: Option<Vec<models::RequestContactImportJsonBodyInner>>,
    ...
    pub new_list: Option<Box<models::RequestContactImportNewList>>,
    ...
    #[serde(
        rename = "emptyContactsAttributes",
        skip_serializing_if = "Option::is_none"
    )]
