...
pub struct ConversationsPushedMessagesPostRequest {
    ...
    #[serde(rename = "visitorId", deserialize_with = "Option::deserialize")]
    pub visitor_id: Option<serde_json::Value>,
    /// message text
    ...
    pub group_id: Option<Option<serde_json::Value>>,
}

impl ConversationsPushedMessagesPostRequest {
    pub fn new(
        visitor_id: Option<serde_json::Value>,
