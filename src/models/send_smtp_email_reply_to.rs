...
/// SendSmtpEmailReplyTo : Email (**required**), along with name (_optional_), on which transactional mail recipients will be able to reply back. For example, **{\"email\":\"ann6533@example.com\", \"name\":\"Ann\"}**
...
impl SendSmtpEmailReplyTo {
    ...
    pub fn new(email: String) -> SendSmtpEmailReplyTo {
        SendSmtpEmailReplyTo { email, name: None }
    }
}
