...
pub struct SubAccountDetailsResponse {
    ...
    pub groups: Option<Vec<models::SubAccountDetailsResponseGroupsInner>>,
    #[serde(rename = "planInfo", skip_serializing_if = "Option::is_none")]
    pub plan_info: Option<Box<models::SubAccountDetailsResponsePlanInfo>>,
}

impl SubAccountDetailsResponse {
    pub fn new() -> SubAccountDetailsResponse {
