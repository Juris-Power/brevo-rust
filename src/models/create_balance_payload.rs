...
/// CreateBalancePayload : Payload for creating a new balance linked to a specific balance definition.
...
impl CreateBalancePayload {
    /// Payload for creating a new balance linked to a specific balance definition.
    pub fn new(balance_definition_id: String) -> CreateBalancePayload {
