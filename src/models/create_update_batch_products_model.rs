...
pub struct CreateUpdateBatchProductsModel {
    ...
    #[serde(rename = "createdCount", skip_serializing_if = "Option::is_none")]
    pub created_count: Option<i64>,
    /// Number of the existing products updated
    #[serde(rename = "updatedCount", skip_serializing_if = "Option::is_none")]
    pub updated_count: Option<i64>,
}

impl CreateUpdateBatchProductsModel {
    pub fn new() -> CreateUpdateBatchProductsModel {
