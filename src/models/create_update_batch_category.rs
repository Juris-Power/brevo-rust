...
pub struct CreateUpdateBatchCategory {
    /// array of categories objects
    #[serde(rename = "categories")]
    pub categories: Vec<models::CreateUpdateCategories>,
...
impl CreateUpdateBatchCategory {
    pub fn new(categories: Vec<models::CreateUpdateCategories>) -> CreateUpdateBatchCategory {
