...
pub struct CreateUpdateBatchProducts {
    /// array of products objects
    #[serde(rename = "products")]
    pub products: Vec<models::CreateUpdateProducts>,
...
impl CreateUpdateBatchProducts {
    pub fn new(products: Vec<models::CreateUpdateProducts>) -> CreateUpdateBatchProducts {
