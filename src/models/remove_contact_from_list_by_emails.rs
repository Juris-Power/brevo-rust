...
pub struct RemoveContactFromListByEmails {
...
impl RemoveContactFromListByEmails {
    pub fn new() -> RemoveContactFromListByEmails {
        RemoveContactFromListByEmails { emails: None }
    }
}
