...
/// CreateBalanceLimitPayload : Payload for setting transaction or amount-based limits on a balance.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateBalanceLimitPayload {
...
impl CreateBalanceLimitPayload {
