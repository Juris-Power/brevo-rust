...
pub struct CrmTasksIdPatchRequest {
    /// Name of task
    ...
    #[serde(rename = "taskTypeId", skip_serializing_if = "Option::is_none")]
...
impl CrmTasksIdPatchRequest {
    pub fn new() -> CrmTasksIdPatchRequest {
