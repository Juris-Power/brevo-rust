...
pub struct UpdateEmailCampaign {
    ...
    pub sender: Option<Box<models::UpdateEmailCampaignSender>>,
    ...
    pub recipients: Option<Box<models::UpdateEmailCampaignRecipients>>,
    ...
    pub email_expiration_date: Option<Box<models::UpdateEmailCampaignEmailExpirationDate>>,
}
