...
Put the package under your project folder in a directory named `brevo` and add the following to `Cargo.toml` under `[dependencies]`:
...
## Documentation For Models
 ...
 - [UpsertrecordsRequestRecordsInnerOneOf](docs/UpsertrecordsRequestRecordsInnerOneOf.md)
